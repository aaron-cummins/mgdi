...
import FormAvisoDesmontaje from 'pages/avisoDesmontaje/components/FormAvisoDesmontaje';
import AvisoDesmontaje from 'pages/avisoDesmontaje/AvisoDesmontaje';
...
describe('Aviso Desmontaje', () => {
    ...
    it('Verificar la existencia del campo Nombre, el campo fecha, el botón Guardar, el botón Cancelar, la casilla de verificación Activo y el icono de cierre de modal en el formulario', () =>{
        ...
        const ButtonNuevoElemento = screen.getByText('Nuevo Aviso Desmontaje')
    ...
    it('Verifica que el mensaje de error desaparezca cuando se ingresan datos válidos en el campo Nombre del formulario', () => {
        ...
        fireEvent.change(InputElemento , { target: { value: 'Aviso Desmontaje 1' } });
    ...
    it('Verificar que los campos se limpien y vuelvan a su estado inicial cuando se hace clic en el botón “Cancelar”', () => {
        ...
        const mockAvisoDesmontaje = {
            ...
            registrarAvisoDesmontaje: jest.fn(),
            actualizarAvisoDesmontaje: jest.fn(),
            obtenerAvisoDesmontaje: jest.fn(),
          };
        
        render(
            <ContextProvider>
                <AvisoDesmontajeContext.Provider value={mockAvisoDesmontaje}>
                    <SnackbarProvider maxSnack={2} >
                        <FormAvisoDesmontaje closeModal={() => {}}/>
                    </SnackbarProvider>
        ...
        //Ingresa un valor en el campo 
        fireEvent.change(InputElemento , { target: { value: 'Nuevo Desmontaje 1' } });
    ...
    it('Verificar si se muestra una notificación de éxito después de enviar el formulario con datos válidos', async () =>{
        ...
        const mockAvisoDesmontaje = {
            avisoDesmontajeActual: null,
            registrarAvisoDesmontaje: jest.fn().mockResolvedValue({
                mensaje: "Aviso desmontaje creado con exito!",
                tipoAlerta: "success",
              }),
              actualizarAvisoDesmontaje: null,
              obtenerAvisoDesmontaje: jest.fn(),
          };
          ...
          render(
            <ContextProvider>
                <AvisoDesmontajeContext.Provider value={mockAvisoDesmontaje}>
                    <SnackbarProvider maxSnack={2} >
                        <FormAvisoDesmontaje closeModal={closeModal}/>
                    </SnackbarProvider>
                </AvisoDesmontajeContext.Provider>
            </ContextProvider>
          );
        ...
        await waitFor(() => {
            expect(mockAvisoDesmontaje.registrarAvisoDesmontaje).toHaveBeenCalledWith({ 
                id: 0,
                nombre: 'Nuevo Desmontaje 1',
                fecha: fechaISO,
                activo: true
            });
        });

        const mensajeExitoso = screen.getByText("Aviso desmontaje creado con exito!");
